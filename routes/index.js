...
router.get('/teams/new', sessionController.loginRequired, teamController.adminOrTeamAdminRequired, teamController.new);
router.post('/teams', teamController.adminOrTeamAdminRequired, upload.single('image'), teamController.create);
router.get('/teams/:teamId(\\d+)/edit', teamController.adminOrAuthorOrTeamAdminRequired, teamController.edit);
router.put('/teams/:teamId(\\d+)', upload.single('image'), teamController.update);
router.delete('/teams/:teamId(\\d+)', teamController.adminOrAuthorOrTeamAdminRequired, teamController.destroy);
...
router.post('/posts', postController.adminOrProposalAdminRequired, upload.single('image'), postController.create);
router.get('/posts/:postId(\\d+)/edit', postController.adminOrAuthorOrProposalAdminRequired, postController.edit);
router.put('/posts/:postId(\\d+)', upload.single('image'), postController.update);
router.delete('/posts/:postId(\\d+)', postController.adminOrAuthorOrProposalAdminRequired, postController.destroy); 
...
router.get('/posts/filter', postController.filter);
